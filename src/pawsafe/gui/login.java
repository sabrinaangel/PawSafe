...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Pilih Hak Akses (Role)");

        jComboBox1.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Admin", "Relawan" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (pengguna != null && pengguna.login(username, password)) {
                // --- BAGIAN PENTING: SET ROLE DI SINI ---
                pawsafe.DataGlobal.roleUser = role; 
                // ----------------------------------------
